...
public class PolynomTestEvgeny 
	...
	public static void test4() throws Exception
		{//test for add and substract.
		System.out.println("******  Test4: add and substract ******");
		String[][] polynoms = {{"3x^2","-6x^3","9x","-2"},{"x","5x","-5"} , {"-6.0x^3" ,"3.0x^2","15.0x", "-7.0"}};					
		Polynom p1 = new Polynom();
	...
	public static void test5() throws Exception
		...
		String[][] polynoms = {{"3x^2","-6x^3","9x","-2"},{"x" , "3x^3"} , {"-18.0x^6" , "9.0x^5" ,"21.0x^4" ,"-3.0x^3", "9.0x^2", "-2.0x"}};
		Polynom p1 = new Polynom();
		Polynom p2 = new Polynom();
		Polynom p3 = new Polynom();
		for (int i = 0; i < polynoms[0].length; i++)
	...
	public static void test6() throws Exception
		...
		String[][] polynoms = {{"3x^2","-6x^3","9x","-2"},{"x","5x","0","-5"} , {"3.00000001x^2","-5.9999999999x^3","9.000000001x","-2"}};
		Polynom p1 = new Polynom();
		Polynom p2 = new Polynom();
		Polynom p3 = new Polynom();
		for (int i = 0; i < polynoms[0].length; i++) 
